...
export default function ParliamentForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-10 text-black">
      <div className="max-w-4xl mx-auto p-6 bg-white shadow-xl rounded-xl border border-indigo-200">
